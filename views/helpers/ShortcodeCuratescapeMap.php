...
class Curatescape_View_Helper_ShortcodeCuratescapeMap extends Zend_View_Helper_Abstract{
	public function ShortcodeCuratescapeMap($args, $view, $html = null){
		...
		$src = (isset($args['src']) && !$includeSubjectsSelect) ? html_escape(plainText($args['src'])) : WEB_ROOT.'/items/browse?output=mobile-json';
		$figcaption = (isset($args['caption'])) ? html_escape(plainText($args['caption'])) : null;
