...
class Curatescape_View_Helper_CuratescapeMap extends Zend_View_Helper_Abstract{
	...
	public function Single($figcaption = null, $class = "single", $jsonSource = null, $heading=true, $ariaLiveMessage = '')
	{
		...
		<curatescape-map>
			...
			data-primary-layer="<?php echo html_escape(flexOption('curatescape_map_primary_layer','CARTO_VOYAGER'));?>"
			data-secondary-layer="<?php echo html_escape(flexOption('curatescape_map_secondary_layer',''));?>"
			data-cluster="0" 
			data-custom-label="<?php echo html_escape(flexOption('curatescape_map_custom_label',''));?>"
			data-custom-url="<?php echo html_escape(flexOption('curatescape_map_custom_url',''));?>"
			data-stadia-key="<?php echo html_escape(flexOption('curatescape_map_stadia_key',''));?>"
			data-cartodb-key="<?php echo html_escape(flexOption('curatescape_map_cartodb_key',''));?>"
			data-prefer-eu="<?php echo html_escape(flexOption('curatescape_map_prefer_eu',0));?>"
			...
			data-color="<?php echo html_escape(flexOption('curatescape_map_marker_color', '#222'));?>"
			>
	...
	public function Multi($figcaption = null, $isGlobal = false, $class = "multi", $tourId = null, $jsonSource = null)
	{
		...
		<curatescape-map>
			...
			data-cartodb-key="<?php echo html_escape(flexOption('curatescape_map_cartodb_key',''));?>"
			data-prefer-eu="<?php echo html_escape(flexOption('curatescape_map_prefer_eu',0));?>"
			data-lat="<?php echo html_escape(flexOption('geolocation_default_latitude', ''));?>"
			data-lon="<?php echo html_escape(flexOption('geolocation_default_longitude', ''));?>"
			data-zoom="<?php echo html_escape(flexOption('geolocation_default_zoom_level', 12));?>"
			data-cluster="<?php echo html_escape(flexOption('curatescape_map_clusters', 0));?>"
			data-cluster-colors="<?php echo html_escape(flexOption('curatescape_map_cluster_colors', ''));?>"
			data-root-url="<?php echo WEB_ROOT;?>"
			...
			data-color="<?php echo html_escape($color = flexOption('curatescape_map_marker_color', '#222'));?>"
