...
class Curatescape_View_Helper_HookConfigForm extends Zend_View_Helper_Abstract{
	public function HookConfigForm(){
		...
		<fieldset>
			...
			<?php echo configFormCheckBox('curatescape_metadata_browse', 'Link Select Elements', "If checked, the Creator and Subject metadata elements will automatically be converted into hyperlinks that point to related Items. Note that this feature may conflict with Search By Metadata plugin." );?>
			<!-- Auto Subtitle -->
		...
		<fieldset>
			...
			<?php echo configFormCheckBox('curatescape_file_markup', 'File Record Markup', 'If checked, the HTML for files on each single file record (i.e. files/show) will use Curatescape style markup. Potentially useful for projects with audio, video, and PDF files.');?>
		</fieldset>
		...
		<fieldset>
			...
			<!-- Primary Nav -->
			<?php echo configFormCheckBox('curatescape_append_primary_nav', 'Append Primary', __('If checked, new navigation items for Home and %1s will be added to the primary navigation menu. If you configure an alternate Item Type name, the modified version will be used instead of the default label. You can modify or disable these items in sitewide <a href="%2s" target="_blank">Navigation settings</a>.', _CURATESCAPE_ITEM_TYPE_NAME_PLURAL_, admin_url('appearance/edit-navigation')));?>
			<!-- Secondary Nav -->
			...
			<?php echo configFormCheckBox('curatescape_shorten_secondary_nav', 'Shorten Secondary', 'If checked, the secondary/Item navigation labels will be shortened to preserve space in some themes. For example, "Browse By Tags" will be shortened to "Tags."');?>
		</fieldset>
		...
		<fieldset>
			...
			<!-- Google Analytics -->
			<?php echo configFormText('curatescape_google_analytics', 'Google Analytics', 'Enter the Web Stream Measurement ID for this website as shown in your Google Analytics account dashboard. May conflict with themes and plugins that already include Google Analytics by other means.', 'Example: G-0123456789');?>
		</fieldset>
