jQuery(document).ready(function () {
    ...
    //relabel Relation as Related Sources
    jQuery("label:contains('Relation')").text('Related Sources');
    ...
    //remove USE HTML and other checkboxes except for Subjects, Creator and Relation
    jQuery('input.add-element, input.remove-element, label.use-html').not('#element-49 input.add-element, #element-49 input.remove-element, #element-46 input.add-element, #element-46 input.remove-element, #element-39 input.add-element, #element-39 input.remove-element, #element-46 label.use-html').remove();
