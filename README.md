...
The first time you activate this plugin, it will install a new [Item Type](https://omeka.org/classic/docs/Content/Item_Types/) called *Curatescape Story*. This Item Type employs multiple new metadata [Elements](https://omeka.org/classic/docs/Admin/Settings/Item_Type_Elements/), including *Story*, *Subtitle*, *Lede*, *Street Address*, *Access Information*, *Official Website*, *Related Resources*, *Factoid*, and more. These Elements form a schema for location-based narrative storytelling. The user-facing name of the *Curatescape Story* item type can be customized to suit your project, e.g. "Historical Markers", "Property Records", "Destinations", etc.
